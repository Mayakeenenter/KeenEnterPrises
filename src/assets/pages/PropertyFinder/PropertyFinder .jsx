  ...
  return (
    <>
      <HelmetProvider>
        <Helmet>
          <title>
            Property Finder && Dubizzle Integration | Keen Enterprises
          </title>
          <meta
            name="description"
        ...
        <section className="propertyFinder">
          ...
          <div className="div-finder">
            ...
            <p>
              ...
              lead source—creating one clean, reliable flow for listings and
              leads in real time.
            </p>
          </div>
        </section>
        ...
        <div className="finall">
          <p>
            If your agency uses Bitrix24 and markets properties on Property
            Finder and Dubizzle—while advertising on Bayut as an external
            platform—this application brings everything together into one
            streamlined system. One dashboard. One workflow. All listings and
            leads, perfectly in sync.
          </p>
        </div>
      </HelmetProvider>
    </>
